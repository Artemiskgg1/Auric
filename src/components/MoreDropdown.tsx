  ...
  return (
    <DropdownMenu open={open}>
      ...
      >
        ...
        {showModeToggle && (
          <>
            <div className="flex items-center border-b border-gray-200 dark:border-zinc-700 py-3.5 px-2.5">
            ...
            <Label htmlFor="dark-mode" className="menuItem">
              Dark Mode
              <DropdownMenuItem className="ml-auto !p-0  dark:hover:bg-zinc-700">
                <Switch
                  id="dark-mode"
                  className="ml-auto"
                  checked={theme === "dark"}
